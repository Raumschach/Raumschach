...
namespace RaumschachTests
{
    ...
    public class UnitTest1
    {
        ...
        public void movePieceToEmpty()
        {
            ...
            Assert.AreEqual("WhitePawn", target._board[0][0, 1].getPiece());
        }
        [Test()]
        public void movePieceFromNullToNull()
        {
            ...
            Assert.AreEqual("WhitePawn", target._board[0][0, 0].getPiece());
        ...
        public void movePieceToPiece()
        {
            ...
            Assert.IsNull(target._board[0][0, 0].getPiece());
            Assert.AreEqual("WhitePawn", target._board[0][1, 0].getPiece());
